% --
\section{\color{BrickRed}\texttt{Wu et. al.}, Vision Transformer-based recognition of diabetic retinopathy grade, \texttt{wu@medical_physics21}~\cite{wu@medical_physics21}}
