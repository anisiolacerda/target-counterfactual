% --
\section{\color{BrickRed}\texttt{Zhang et. al.}, Can subnetwork structure be the key to out-of-distribution generalization?, \texttt{zhang@icml21}~\cite{zhang@icml21}}
