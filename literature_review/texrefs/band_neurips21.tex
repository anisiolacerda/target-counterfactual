% --
\section{\color{BrickRed}\texttt{Band et. al.}, Benchmarking Bayesian Deep Learning on Diabetic Retinopathy Detection Tasks, \texttt{band@neurips21}~\cite{band@neurips21}}
