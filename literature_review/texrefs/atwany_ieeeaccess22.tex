% --
\section{\color{BrickRed}\texttt{Atwany et. al.}, Deep learning techniques for diabetic retinopathy classification: A survey, \texttt{atwany@ieeeaccess22}~\cite{atwany@ieeeaccess22}}
