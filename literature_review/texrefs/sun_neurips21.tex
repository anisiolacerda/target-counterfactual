% --
\section{\color{BrickRed}\texttt{Sun et. al.}, Recovering latent causal factor for generalization to distributional shifts, \texttt{sun@neurips21}~\cite{sun@neurips21}}
