% --
\section{\color{BrickRed}\texttt{Liu et. al.}, Learning causal semantic representation for out-of-distribution prediction, \texttt{liu@neurips21}~\cite{liu@neurips21}}
