...
- Step 2b: Replicate VCIP results on MIMIC-III real ICU data (feature/mimic-iii-experiments branch). Requires PhysioNet data preprocessing. See `context/MIMIC_DATA_SETUP.md` and `context/MIMIC_EXPERIMENT_MAP.md`.
