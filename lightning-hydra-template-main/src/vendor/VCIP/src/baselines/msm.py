...
from src.baselines import TimeVaryingCausalModel
...
class MSM(TimeVaryingCausalModel):
    """
    Pytorch-Lightning implementation of Marginal Structural baselines (MSMs) (https://pubmed.ncbi.nlm.nih.gov/10955408/)
    """
