...
from src.baselines.utils import grad_reverse, BRTreatmentOutcomeHead, AlphaRise, ROutcomeVitalsHead
        ...
        for t in range(self.hparams.dataset.projection_horizon + 1):
            ...
            for m in range(self.mc_samples):
                ...
                if self.holdout_resid is not None:
                    ...
                    print('resid_at_split shape:', resid_at_split.shape)
                    print('self.holdout_resid shape:', self.holdout_resid.shape)
                    print('outputs_next_vitals_scaled shape:', outputs_next_vitals_scaled.shape)
